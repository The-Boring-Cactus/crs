      ...
      <section>
        ...
        <div class="actions mt-4 space-y-4">
          <n-button class="actions--btn" text @click="setupConnection">
            <i-carbon:connect class="h-4 w-4 mr-2" /> {{ $t('app.set-up-a-new-connection') }}
          </n-button>
          <n-button class="actions--btn" text @click="addNewTab('')">
            <i-carbon:new-tab class="h-4 w-4 mr-2" /> {{ $t('app.new-tab') }}
          </n-button>
          <n-button class="actions--btn" text @click="selectQueries">
            <i-carbon:query-queue class="h-4 w-4 mr-2" /> {{ $t('app.select-queries') }}.
          </n-button>
        </div>
      </section>
      <section class="mt-16">
