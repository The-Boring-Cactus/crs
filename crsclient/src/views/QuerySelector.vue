<template>
  <div class="query-selector">
    ...
    <button class="query-selector--added" @click="handleAddQuery('')">
      <i-carbon-add class="h-5 w-5 hover:bg-gray-200 hover:dark:bg-dark-300 hover:rounded-sm" />
    </button>
  </div>
</template>
