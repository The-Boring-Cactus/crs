...
public class WS
{
    public static async Task HandleWebSocketMessage(WebSocketManager manager, IWebsocketConnection socket, string messageText)
    {
        try
        {
    ...
    public static async Task HandleAuthentication(WebSocketManager manager, IWebsocketConnection socket, WebSocketMessage message)
    {
        try
        {
    ...
    public static async Task HandleReportExecution(WebSocketManager manager, IWebsocketConnection socket, WebSocketMessage message)
    {
        try
        {
            await SendWebSocketMessage(socket, new WebSocketMessage
    ...
    public static async Task SendWebSocketMessage(IWebsocketConnection socket, WebSocketMessage message)
    {
        try
        {
            ...
            await socket.Send(new ReadOnlyMemory<byte>(bytes));
        }
        catch (Exception ex)
        {
