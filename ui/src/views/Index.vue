...
export default {
    ...
    setup() {
            ...
            datasets: [
                {
                    label: 'Ventas 2024',
                    data: [12, 19, 3, 5, 2, 3],
                    backgroundColor: ['rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.2)', 'rgba(255, 205, 86, 0.2)', 'rgba(75, 192, 192, 0.2)', 'rgba(153, 102, 255, 0.2)', 'rgba(255, 159, 64, 0.2)'],
        ...
        const getChartDescription = (type) =>
            ({
                line: 'Ideal para mostrar tendencias a lo largo del tiempo.',
                bar: 'Perfecto para comparar categorías de datos.',
                pie: 'Excelente para mostrar proporciones de un total.',
                doughnut: 'Similar al gráfico de pastel pero con un centro hueco.',
                polarArea: 'Combina características de gráficos de pastel y radar.',
                radar: 'Útil para mostrar múltiples métricas en un formato circular.',
                scatter: 'Ideal para mostrar correlaciones entre dos variables.',
                bubble: 'Permite mostrar tres dimensiones de datos usando x, y y tamaño.',
                area: 'Similar al gráfico de línea pero con el área sombreada.',
                mixed: 'Combina diferentes tipos de gráficos en uno solo.'
            })[type] || 'Descripción no disponible.';
...
<template>
    <div class="chart-dashboard theme-light">
        ...
        <div class="chart-controls">
            ...
            <button @click="toggleAnimation">{{ animationEnabled ? 'Desactivar' : 'Activar' }} Animación</button>
        </div>
...
.chart-controls button:nth-child(1) {
...
.chart-controls button:nth-child(3) {
    background-color: #2196f3;
    color: white;
}
.chart-controls button:nth-child(4) {
...
.theme-light .chart-selector label,
.theme-light .theme-selector label {
    color: #555;
}
.theme-light .chart-selector select {
    background-color: white;
    border-color: #ddd;
    color: #333;
}
.theme-light .chart-selector select:focus {
    border-color: #4caf50;
}
...
.theme-light .chart-info {
    background-color: #f0f8ff;
    border-color: #b0d4f1;
}
.theme-light .chart-info h3 {
    color: #2c5aa0;
}
.theme-light .chart-info p {
    color: #555;
}
