...
<script>
    ...
    import {getControlPosition, createCoreData} from '@/helpers/draggableUtils.ts';
    import {getColsFromBreakpoint} from '@/helpers/responsiveUtils.ts';
    import {getDocumentDir} from "@/helpers/DOM.ts";
